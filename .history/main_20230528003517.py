...
def main(time=time):    
    ...
    driver.get('https://www.spire.umass.edu/psc/heproda_newwin/EMPLOYEE/SA/c/NUI_FRAMEWORK.PT_AGSTARTPAGE_NUI.GBL?CONTEXTIDPARAMS=TEMPLATE_ID%3aPTPPNAVCOL&scname=UM_HOUSING0&PTPPB_GROUPLET_ID=UM_HOUSING0&CRefName=UM_HOUSING0')
    time.sleep(3)
    ...
    print("Found rooms! Sending Email")

    msg = EmailMessage()
    msg.set_content("Rooms Found")

    msg['Subject'] = 'Rooms Found!'
    msg['From'] = ''
    msg['To'] = 'arzimmerman@umass.edu'

    s = smtplib.SMTP('localhost')
    s.send_message(msg)
    s.quit()
    print("Email sent, quitting!")
    quit()
main()
